// Write a Java Program to print the sum of all element in an array
package corejava.arraydemo;

import java.util.Scanner;

public class FindSumOfAllArrayElement {
	...
	public static void findAnAverageOfElements() {
		if (noArray.length == 1) {
			System.out.println("Sum of All ArrayElement is "+ noArray[0]);
		}else {
			int sum =0;
			for(int cnt=0;cnt<noArray.length;cnt++) {
				sum = sum + noArray[cnt];
			}
			System.out.println("Sum of All arrayElement is "+ sum);
		}
