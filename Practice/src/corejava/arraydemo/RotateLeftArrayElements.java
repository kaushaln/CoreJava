...
public class RotateLeftArrayElements {
	...
	public static void main(String[] args) {
		...
		if (arraySize<2) {
			...
			noArray[0]= noArray[0]-noArray[1];
			System.out.println("Array Elements After Rotating left are as below:");
			displayArrayElements();
	...
	public static void RotateLeftArrayElement() {
		int temp=0;
		for(int cnt=0;cnt<noArray.length;cnt++) {
			if(cnt==0) {
				temp = noArray[cnt];
				noArray[cnt]=noArray[cnt+1];
